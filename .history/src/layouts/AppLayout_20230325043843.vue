                    ...
                    <label class="modal-box relative" for="">
                        ...
                        <div class="grid grid-cols-2 items-center border-2 justify-items-center rounded-xl border-gray-200">
                            ...
                            <div class="text-center">
                                <img src="/assets/icons/flag.png" class="w-8 mb-3 mx-auto" alt="">
                                <h5 class="font-bold m-0">20 Hari</h5>
                                <p class="text-sm">Tujuan target</p>
                            </div>
                        </div>
                        <button  class="btn mt-3 bg-gray-200 text-gray-600 w-full rounded-xl shadow-[0px_2px_0px_3px] shadow-gray-400">
                            Tutup
                        </button>
                    </label>
                </label>
