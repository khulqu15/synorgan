<template>
    <ion-page>
        <ion-content>
            <div class="grid grid-cols-1 bg-base-200 text-center min-h-screen justify-items-center" :class="{'items-center': intro < 3, 'pt-12': intro >= 3}">
                ...
                <div class="w-3/4 p-4">
                    ...
                    <div :class="{'opacity-0 invisible h-0': intro !== 3, 'opacity-1 visible': intro === 3}" class="transition-all">
                        <div class="text-left">
                            <div class="tooltip tooltip-open tooltip-right tooltip-primary w-1/2 relative right-2" data-tip="Nama kamu siapa ?">
                                <img src="assets/sio face.svg" alt="sio" class="relative bottom-2 w-11/12">
                            </div>
                        </div>
                        <div class="fixed bottom-0 left-0 p-6 w-full">
                            <button @click="intro += 1" class="btn btn-primary w-full rounded-xl shadow-[0px_2px_0px_3px] shadow-indigo-800">Lanjutkan</button>
