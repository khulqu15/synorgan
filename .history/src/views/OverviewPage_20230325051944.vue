                        ...
                        <div>
                            <div class="w-full bg-white p-4 rounded-xl">
                                <div class="flex gap-2 items-center">
                                    <img src="/assets/icons/hidung.png" class="w-10" alt="">
                                    <h4 class="m-0 font-semibold text-gray-600">Hidung</h4>
                                </div>
                                <p class="leading-tight mt-3">Mempelajari fungsi, bagian bagian dari hidung. dan terdapat kuis menarik mengenai hidung.</p>
                            </div>
                        </div>
