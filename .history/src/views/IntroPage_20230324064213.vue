                ...
                <div class="p-4" :class="{'w-3/4': intro < 3, 'w-full': intro >= 3}">
                    ...
                    <div :class="{'opacity-0 invisible h-0': intro !== 3, 'opacity-1 visible': intro === 3}" class="transition-all">
                        ...
                        <div class="relative w-full">
                            <div class="absolute w-full bg-white h-144 -top-4 p-12 rounded-2xl left-0">
                                <input type="text" v-model="user.name" placeholder="contoh: Andi" class="input w-full shadow-[0px_2px_0px_3px] shadow-gray-300" />
