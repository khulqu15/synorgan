                    ...
                    <div :class="{'opacity-0 invisible h-0': intro !== 3, 'opacity-1 visible': intro === 3}" class="transition-all">
                        ...
                        <div class="fixed bottom-0 left-0 p-6 w-full">
                            <button :disabled="user.name === null && user.name.length <= 2" @click="user.name !== null && user.name.length > 2 ? intro += 1 : intro = intro" 
                                ...
                                :class="{'btn-primary shadow-indigo-800': user.name !== null && user.name.length > 2, 'btn-secondary shadow-grey-400': user.name === null && user.name.length <= 2}">Lanjutkan</button>
                        </div>
                    </div>
                </div>
            </div>
