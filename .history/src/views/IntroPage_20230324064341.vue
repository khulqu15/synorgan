                ...
                <div class="p-4" :class="{'w-3/4': intro < 3, 'w-full': intro >= 3}">
                    ...
                    <div :class="{'opacity-0 invisible h-0': intro !== 3, 'opacity-1 visible': intro === 3}" class="transition-all">
                        ...
                        <div class="relative w-full">
                            <div class="absolute w-full bg-white h-144 -top-4 p-12 text-left rounded-2xl left-0">
                                <label for="user-name" class="relative -top-3 text-gray-500">Masukkan nama kamu</label>
