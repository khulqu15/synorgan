<template>
    <div class="w-full h-16 fixed left-0 top-0">
        <div class="border-b-2 p-3 bg-primary pt-6 shadow-5xl border-gray-200">
            <div class="flex items-center justify-items-center justify-center text-center">
                ...
                <div class="grow">
                    <button class="btn btn-ghost">
                        <div class="flex items-center gap-2">
                            <img src="assets/icons/hot-sale.png" class="w-8 border-2 border-white" alt="">
                ...
                <div class="grow">
                    <button class="btn btn-ghost">
                        <div class="flex items-center gap-2">
                            <img src="assets/icons/gem.png" class="w-8 border-2 border-white" alt="">
                ...
                <div class="grow">
                    <button class="btn btn-ghost">
                        <div class="flex items-center gap-2">
                            <img src="assets/icons/heart.png" class="w-8 border-2 border-white" alt="">
